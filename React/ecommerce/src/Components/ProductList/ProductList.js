...
// In React, "props" is a short form for "properties," and it is a system for passing data from a parent component to a child component.
function ProductList(){
    ...
    return <div className="productSearch">
        ...
        <form>
            <label for="serachFilter"> Search</label>
            <input id="serachFilter" onInput={onSearchChange} value={searchValue} type="text" placeholder="search" /> 
        
            <label for="sortLabel"> Sort by:</label>
             <select id="sortLabel" value={selectedValue} onChange={onSelectOption}>
		        {options}
		      </select>
        </form>
...

        {
            ...
            // and having unique keys helps React identify which items have been added, removed, or modified.

             products.map((product)=>{
                return <Product onDelete={onRemoveProduct} key={product.id} data={product} />
             })
